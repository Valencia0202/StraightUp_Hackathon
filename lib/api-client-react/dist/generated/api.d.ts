...
import type { CreateOpenaiConversationBody, HealthStatus, OpenaiConversation, OpenaiConversationWithMessages, OpenaiError, OpenaiMessage, SendOpenaiMessageBody, UpdateOpenaiConversationBody } from "./api.schemas";
...
/**
 * @summary Update conversation (e.g. rename title)
 */
export declare const getUpdateOpenaiConversationUrl: (id: number) => string;
export declare const updateOpenaiConversation: (id: number, updateOpenaiConversationBody: UpdateOpenaiConversationBody, options?: RequestInit) => Promise<OpenaiConversation>;
export declare const getUpdateOpenaiConversationMutationOptions: <TError = ErrorType<OpenaiError>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<Awaited<ReturnType<typeof updateOpenaiConversation>>, TError, {
        id: number;
        data: BodyType<UpdateOpenaiConversationBody>;
    }, TContext>;
    request?: SecondParameter<typeof customFetch>;
}) => UseMutationOptions<Awaited<ReturnType<typeof updateOpenaiConversation>>, TError, {
    id: number;
    data: BodyType<UpdateOpenaiConversationBody>;
}, TContext>;
export type UpdateOpenaiConversationMutationResult = NonNullable<Awaited<ReturnType<typeof updateOpenaiConversation>>>;
export type UpdateOpenaiConversationMutationBody = BodyType<UpdateOpenaiConversationBody>;
export type UpdateOpenaiConversationMutationError = ErrorType<OpenaiError>;
/**
 * @summary Update conversation (e.g. rename title)
 */
export declare const useUpdateOpenaiConversation: <TError = ErrorType<OpenaiError>, TContext = unknown>(options?: {
    mutation?: UseMutationOptions<Awaited<ReturnType<typeof updateOpenaiConversation>>, TError, {
        id: number;
        data: BodyType<UpdateOpenaiConversationBody>;
    }, TContext>;
    request?: SecondParameter<typeof customFetch>;
}) => UseMutationResult<Awaited<ReturnType<typeof updateOpenaiConversation>>, TError, {
    id: number;
    data: BodyType<UpdateOpenaiConversationBody>;
}, TContext>;
/**
